...
HD_PWD='/home/hennig/Bureau/BEMAC/BE-CAM/CAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TransReceivCollision.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TransReceivCollision.tcl
